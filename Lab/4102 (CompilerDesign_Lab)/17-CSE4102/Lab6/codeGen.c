...
void print_assembly()
{
    ...
    for(i=0; i<code_offset; i++)
    {
        ...
        if(code[i].op == ADD || code[i].op == SUB || code[i].op == MUL || code[i].op == DIV || code[i].op == GT_OP || code[i].op == LT_OP || code[i].op == EQ_OP)
            stack_variable_counter--;
        ...
        switch(code[i].op)
        {
            ...
            case SUB:
                            printf("\tsub ebx, 4\n");
                            printf("\tmov eax, [ebx] ; right operand\n");
                            printf("\tsub ebx, 4\n");
                            printf("\tmov edx, [ebx] ; left operand\n");
                            printf("\tsub edx, eax ; left - right\n");
            ...
            case DIV:
                            printf("\tsub ebx, 4\n");
                            printf("\tmov eax, [ebx] ; divisor (right)\n");
                            printf("\tmov ecx, eax\n");
                            printf("\tsub ebx, 4\n");
                            printf("\tmov edx, [ebx] ; dividend (left)\n");
                            printf("\tmov eax, edx\n");
                            printf("\tcdq ; sign extend into edx:eax\n");
                            printf("\tidiv ecx\n");
                            printf("\tmov dword ptr [ebx], eax ; quotient\n");
                            printf("\tadd ebx, 4\n\n");
                            break;
            case GT_OP:
                            printf("\tsub ebx, 4\n");
            ...
            case IF_START:
                            ...
                            printf("\tcmp eax, 0\n");
                            {
                                char else_start_label[64] = "ELSE_START_LABEL_";
                                char number[16];
                                sprintf(number, "%d", code[i].arg);
            ...
            case WHILE_LABEL:
                            {
                                char while_start_label[64]="WHILE_START_LABEL_";
                                char number[16];
                                sprintf(number, "%d", code[i].arg);
            ...
            case WHILE_START:
                            ...
                            printf("\tcmp eax, 0\n");
                            {
                                char while_end_label[64]="WHILE_END_LABEL_";
                                char number[16];
                                sprintf(number, "%d", code[i].arg);
