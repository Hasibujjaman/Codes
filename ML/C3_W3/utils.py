...
def plot_optimal_policy_return(num_states, optimal_policy, rewards, V, gamma):
    ...
    ax.set_title("Optimal policy\ngamma = "+str(gamma),fontsize = 16)
    plt.show()

def plot_q_values(num_states, q_left_star, q_right_star, rewards, gamma):
...
def generate_visualization(terminal_left_reward, terminal_right_reward, each_step_reward, gamma, misstep_prob):
    ...
    plot_optimal_policy_return(num_states, optimal_policy, rewards, V, gamma)
    plot_q_values(num_states, q_left_star, q_right_star, rewards, gamma)
