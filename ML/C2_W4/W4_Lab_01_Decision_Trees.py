...
def weighted_entropy(X,y,left_indices,right_indices):
    """
    This function takes the dataset, the indices we chose to split and returns the weighted entropy of the nodes that created from splitting.
    """
...
# Now, let's compute the information gain if we split the root node for each feature: ear shape(already shown before), face shape, and whiskers.
