...
def load_data():
    ...
    item_train = genfromtxt('./C3_W2/data2/content_item_train.csv', delimiter=',')
    user_train = genfromtxt('./C3_W2/data2/content_user_train.csv', delimiter=',')
    y_train    = genfromtxt('./C3_W2/data2/content_y_train.csv', delimiter=',')
    with open('./C3_W2/data2/content_item_train_header.txt', newline='') as f:    #csv reader handles quoted strings better
        item_features = list(csv.reader(f))[0]
    with open('./C3_W2/data2/content_user_train_header.txt', newline='') as f:
        user_features = list(csv.reader(f))[0]
    item_vecs = genfromtxt('./C3_W2/data2/content_item_vecs.csv', delimiter=',')

    movie_dict = defaultdict(dict)
    count = 0
#    with open('./C3_W2/data2/movies.csv', newline='') as csvfile:
    with open('./C3_W2/data2/content_movie_list.csv', newline='') as csvfile:
    ...
    with open('./C3_W2/data2/content_user_to_genre.pickle', 'rb') as f:
