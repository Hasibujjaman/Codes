...
public class RVAdapter extends RecyclerView.Adapter<RVAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        switch (DayActivity.day){
            case "Saturday" :{
                    //Toast.makeText(context,"Hello Sat",Toast.LENGTH_SHORT).show();
            ...
            case "Sunday" :{
                Toast.makeText(context,"Hello Sun",Toast.LENGTH_SHORT).show();
            ...
            case "Monday" :{
                Toast.makeText(context,"Hello Mon",Toast.LENGTH_SHORT).show();
            ...
            case "Tuesday" :{
                Toast.makeText(context,"Hello Tue",Toast.LENGTH_SHORT).show();
            ...
            case "Wednesday" :{
                Toast.makeText(context,"Hello Wed",Toast.LENGTH_SHORT).show();
            ...
            case "Thursday" :{
                Toast.makeText(context,"Hello Thu",Toast.LENGTH_SHORT).show();
            ...
            case "Friday" :{
                Toast.makeText(context,"Hello Fri",Toast.LENGTH_SHORT).show();
